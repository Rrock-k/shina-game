...
export const BASE_CAR_SPEED = 11.7;
export const BASE_TIME_SPEED = 60;
...
export const CONFIG = {
  ...
  ZONE_LAYOUT: {
    house: { block: { i: 0, j: 0 }, cells: [[0, 0]] },
    relatives: { block: { i: 5, j: 0 }, cells: [[1, 0]] },
    work: { block: { i: 3, j: 1 }, cells: [[0, 1], [1, 1]] },
    box: { block: { i: 1, j: 2 }, cells: [[0, 1], [0, 2]] },
    institute: { block: { i: 5, j: 2 }, cells: [[0, 0], [1, 0], [1, 1]] }
  },
  ZONES: {
