...
### 2.1 Закрытие меню по клику вне модального окна
- [ ] **Задача**: Добавить возможность закрытия меню по клику вне модального окна
- [ ] **Файлы**: `src/rendering/UIRenderer.js`
- [ ] **Детали**: Добавить обработчик клика на backdrop

### 2.2 Горячая клавиша J для журнала
- [ ] **Задача**: Добавить возможность открытия журнала по клавише J
- [ ] **Файлы**: `src/main.js`, `src/game/JournalManager.js`
- [ ] **Детали**: Добавить обработчик клавиатуры

### 2.3 Отображение текущего состояния переключателей
- [ ] **Задача**: Показывать текущее состояние переключателей в меню
- [ ] **Файлы**: `src/rendering/UIRenderer.js`
- [ ] **Детали**: Обновлять текст кнопок в зависимости от состояния

## Этап 3: Анимации и визуальные улучшения (Важно)
...
### 4.2 Вынос стилей в отдельный CSS файл
...
### 4.3 Упрощение обработчиков событий
...
- **Всего задач**: 20
- **Выполнено**: 6 (1.1, 1.2, 1.3, 1.4, 1.5, 1.6)
- **В процессе**: 0
- **Осталось**: 14
