...
export class RouteSchedule {
    ...
    addHighPriorityTask(task) {
        ...
        // Если добавили задачу в начало, нужно сдвинуть текущий индекс
     ...
     * @returns {number} Индекс найденной задачи или -1 если не найдена
     */
    ...
    /**
     * Заменить все задачи новым списком
     * @param {Array} newSchedule Новый список задач
     */
